...
- The greatest amount of images in the set had a Distinctness of 3
  (good)

- The least amount of images in the set had a Distinctness of 1 (poor)

- All 3 Distinctness’ Mean Velocity’s were greater than the exact speed
  of light in a vacuum (299792.458 km/s)

  - It is very interesting that Mean Velocity that is closest to the
    exact speed of light in a vacuum is the one derived from the images
    with a Distinctness of 1 - poor

***Why might your table differ from Michelson’s?***

- A difference in rounding and significant figures

  - Michelson’s table appears to use 5 significant figures while mine
    uses 7 giving a different and possibly more precise reading
...
- Michelson’s uncertainty had a magnitude of 102 km/s (plus or minus 51
  km/s)

- The true error had a magnitude of approximately 151 km/s
...
- Both means follow a similar increasing and decreasing pattern over
  time

***Differences***

- The Real data’s mean velocity is much higher around June 9th

- The Simulated data’s mean velocity is much higher around June 26th

- The Real data seems to have more outliers overall
...
df_q2 %>%
  ...
  geom_point(
    mapping = aes(x = Date, y = Velocity, color = Temp, size = Distinctness)
  ) 
```
...
- Data on June 23rd was recorded at a high temperature along with good
  distinctness
- There are several grouping of data with high distinctness surrounding
  the exact value for the speed of light in a vacuum
