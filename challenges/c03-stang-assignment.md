...
- Is there “one true value” for the material properties of Aluminum?
  - No, E and nu are not consistent
- How many aluminum alloys are in this dataset? How do you know?
  - One type of alloy, al_24st, since it is the only one listed under
    alloy
- What angles were tested?
  - 0, 45, and 90 degrees
- What thicknesses were tested?
  - 0.022, 0.032, 0.064, 0.081 inches
- How do E and nu change as thickness changes (at the same angle)?
...
- The answer using the current dataset would be that the trend is
  inconsistent or there is no trend
- If there was additional data available, there is the possibility that
  it would show an inverse relationship between E and thickness which is
  somewhat apparent in the data taken at 45 degrees
