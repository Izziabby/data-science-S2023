...
-   Which model is *most accurate*? Which is *least accurate*?
    -   the cheat model is the *most* accurate (lower mse and higher rsquare is more accurate)
...
-   What *Category* of variable is `avg_T`? Why is it such an effective predictor?
    ...
    -   it is an effective predictor because avg_T is used to calculate T_norm
...
-   Which model tends to be more accurate? How can you tell from this predicted-vs-actual plot?
    -   my model from q4 seems to be more accurate because the points follow the trend line where the predicted value is close to the actual value
-   Which model tends to be *more confident* in its predictions? Put differently, which model has *narrower prediction intervals*?
    -   my q4 model seems to be more confident because it has narrower prediction intervals
...
-   How much do you trust your model? Why?
    -   I trust this model as 93% of the validation data falls within the predicted range and the rsquared value is approximately 0.67
-   What kind of interval---confidence or prediction---would you use for this task, and why?
    -   I would use prediction interval because it summarizes information about future observations which is the goal of our model
    -   Additionally, PI is useful when we care more about individual observations---rather than the aggregate behavior
-   What fraction of validation cases lie within the interval you predict? How does this compare with `pr_level`?
    ...
    -   the pr_level was supposed to be .8 which is lower than our prediction
...
-   Are there any other recommendations you would provide?
    -   look at other variable to see which makes sense and which can make the most confident model
