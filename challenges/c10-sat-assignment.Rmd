...
corr_gpa <- cor.test(df_composite$high_GPA, df_composite$univ_GPA)

corr_sat <- cor.test(df_composite$both_SAT, df_composite$univ_GPA)
...
-   How do the results here compare with the visual you created in q2?
    -   This makes sense because high_GPA has a large bump in the same
        area as univ_GPA
-   Based on these results, what can we say about the predictive
    capabilities of both `high_GPA` and `both_SAT` to predict
    `univ_GPA`?
    -   high_GPA seems to be better at predicting univ_GPA since they
...
#   col_mean <- mean(col)
#   std_col <- sd(col)
#   col_se <- std_col / sqrt(length(col))
#   
#   tibble(
#     # term = "col", 
#     # estimate = est,
...
-   How does your estimate from q5 compare with your estimate from q4?
    -   The estimate from q5 is 0.7795631
-   How does your CI from q5 compare with your CI from q4?
    -   The estimate from q5 is much narrower than the estimate from q4
