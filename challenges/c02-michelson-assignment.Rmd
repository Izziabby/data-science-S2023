...
-   The greatest amount of images in the set had a Distinctness of 3 (good)

-   The least amount of images in the set had a Distinctness of 1 (poor)

-   All 3 Distinctness' Mean Velocity's were greater than the exact speed of light in a vacuum (299792.458 km/s)

    -   It is very interesting that Mean Velocity that is closest to the exact speed of light in a vacuum is the one derived from the images with a Distinctness of 1 - poor

***Why might your table differ from Michelson's?***

-   A difference in rounding and significant figures

    -   Michelson's table appears to use 5 significant figures while mine uses 7 giving a different and possibly more precise reading
...
-   Michelson's uncertainty had a magnitude of 102 km/s (plus or minus 51 km/s)
...
-   Both means follow a similar increasing and decreasing pattern over time
...
-   Data on June 23rd was recorded at a high temperature along with good distinctness
-   There are several grouping of data with high distinctness surrounding the exact value for the speed of light in a vacuum
-   The data with low distinctness was taken at a variety of temperatures
-   The data taken with the lowest temperature all had velocities under Michelson's velocity estimate
-   **Are there other patterns in the data that might help explain the difference between Michelson's estimate and LIGHTSPEED_VACUUM?**
    -   There does not seem to be other patterns in the data set that help explain the difference between Michelson's estimate and LIGHTSPEED_VACUUM.
