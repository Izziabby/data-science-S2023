...
**Observations**:
 - "stacked" default view is a sum of each 'cty' values no the real 'hwy' values
 - gives misleading view of data set
 - only for 1 to 1  (only 1x to 1y)
...
**Observations**:
- show the cars count
- the most is suvs, then compacts, then midsize
...
**Observations**:
- shows which are the most numerous
- shows the qty of 4,f, and r drive for each type of car
  - pickups and suvs have the most 4 wheel drive and this type of car tends to have 4 wheel drive 
  - midsize and compacts have the most f drive and and this type of car tends to have f wheel drive
...
- What was the difference between `v1` and `v2`?
    - v1 shows the same variable (class) using 2 aes
    - v2 shows 2 variables(class and drv) using 2 aes
...
**Observations**
- certain manufacturers seem to favor particular classes of cars ex: jeep only has suvs, toyota "favors" compacts
