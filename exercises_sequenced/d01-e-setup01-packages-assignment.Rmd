...
Install packages is only run once before using that package

Library is called when you need to use functions in a package and is typically run once at the beginning of necessary code files 
