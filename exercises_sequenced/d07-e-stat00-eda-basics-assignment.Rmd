...
**Observations**:
  ...
  * Ideal cut is more numerous than all of the other cuts 
...
* This is not a good graph because it is very hard to see the variation within each cut = overplotting
...
**Observations**:
  * median of ideal is lower than other cuts -> this shows that gemcutter trade cut for carrat
  * largest carrat tends to be fair cut (cutting gemstone reduces its weight)
  * ideal diamonds are cheaper (usually lower carat)
