...
-   they carry out the same computation
-   v2 uses a pipe
...
-   The 'summarize' alone averages the price of all of the data

-   The 'group by' summarizes the price for each unique combination of color and clarity
